...
import { Trash2, Plus, Users, Radio, Loader2 } from "lucide-react";
        ...
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-gray-600 text-sm sm:text-base">
              Gestión de canales y usuarios del sistema
            </p>
          </div>
        </div>
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription className="text-sm">
                      Registra un nuevo canal de televisión
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                        ...
                        <Button
                          onClick={() =>
                            confirmarAccion(
                              `¿Crear usuario "${
                                nuevoUsuario.name
                              }" con rol ${getRoleName(nuevoUsuario.role)}?`,
                              agregarUsuario
                            )
                          }
                          disabled={
                            !nuevoUsuario.password.trim() ||
                            !nuevoUsuario.name.trim()
                          }
